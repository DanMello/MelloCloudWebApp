    ...
    return (
      <div>
        <div className="react-simpler-forms-input-container">
          ...
          <Input
            ...
            validators={[
              ...
              {
                method: "maxCharaters",
                error: "Name can only contain 35 characters.",
              },
            ]}
          />
        </div>
        ...
        <div className="react-simpler-forms-input-container">
          ...
          <div className="react-simpler-forms-note">
        ...
        <div className="react-simpler-forms-input-container">
          ...
          <label className="react-simpler-forms-label">
            Select a State you like:
          </label>
        ...
        <div className="react-simpler-forms-input-container">
          <div
            className="react-simpler-forms-label"
        ...
        <div>
          <div>
            <Input
              {...formProps}
              name="question"
              value="I agree that react-simpler-forms is cool."
              type="checkbox"
            />
            <label
              style={{
                ...
                color: "rgba(260, 260, 260, 0.7)",
              }}
            >
              By checking you agree that react-simpler-forms is cool.
            </label>
          </div>
        </div>
