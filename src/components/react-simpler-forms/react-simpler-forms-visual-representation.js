...
import "./react-simpler-forms.scss";
        ...
        <div className="react-simpler-forms-main">
          ...
          <div className="react-simper-forms-heading-inner">
            ...
            <div>
              ...
              <div className="react-simpler-forms-title">
                Desktop live demo.
              </div>
            </div>
          </div>
          ...
          <div className="react-simpler-seperate-containers">
            <div className="react-simpler-forms-container-top">
              <h1 className="react-simpler-forms-sub-headings">
                React Simpler Forms Demo v1.0.2
              </h1>

              <div className="react-simpler-forms-form-type-radio-containers">
                <div className="react-simpler-forms-form-type-heading">
                  Form type
                </div>
                ...
                <div className="react-simpler-forms-form-type-radio-containers">
                  <input
                    ...
                    checked={this.state.checked === "single"}
                  />
                  <label className="react-simpler-forms-form-type-labels">
                    Single step form
                  </label>
                </div>
                ...
                <div className="react-simpler-forms-form-type-radio-containers">
                  <input
                    ...
                    value="multi"
                    onChange={this.updateFormType}
                    checked={this.state.checked === "multi"}
                  />
                  <label className="react-simpler-forms-form-type-labels">
                    Multi step form
                  </label>
              ...
              <div className="react-simpler-forms-form-type-radio-containers">
                ...
                <div className="react-simpler-forms-form-type-radio-containers">
                  ...
                  />
                  <label className="react-simpler-forms-form-type-labels">
                    disabled until all inputs validated.
                  </label>
                </div>
              </div>
            </div>

            <div className="react-simpler-forms-container-bottom">
              <div
                className="react-simpler-forms-container-right"
                ref={this._form}
              >
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  {formProps.form.loading && (
                    <Loader
                      containerClass="react-simpler-forms-loader"
                      width={"25px"}
                      height={"25px"}
                      color={"rgb(0,125,255)"}
                    />
                ...
                <div className="react-simpler-forms-success-response">
                  {formProps.form.response}
                </div>
                <div className="react-simpler-forms-error-response">
                  {formProps.form.error}
                </div>
              ...
              <div className="react-simpler-forms-container-left">
                ...
                <div>
                  <div className="react-simpler-forms-statement">
                  ...
                  <div className="react-simpler-state-container">
                    <div>
                      step:{" "}
                      <div className={this.className(formProps.form.step)}>
                        {formProps.form.step}
                      </div>
                      ,
                    </div>
                    <div>
                      error:{" "}
                      <div className={this.className(formProps.form.error)}>
                        {String(formProps.form.error)}
                      </div>
                      ,
                    </div>
                    <div>
                      response:{" "}
                      <div className={this.className(formProps.form.response)}>
                        {String(formProps.form.response)}
                      </div>
                      ,
                    </div>
                    <div>
                      loading:{" "}
                      <div className={this.className(formProps.form.loading)}>
                        {String(formProps.form.loading)}
                      </div>
                      ,
                    </div>
                    <div>
                      Data: {"{"}{" "}
                      {Object.keys(formProps.form.data).map((item) => {
                        return (
                          <div
                          ...
                          >
                            ...
                            {Object.keys(formProps.form.data[item]).map(
                              (property) => {
                                    ...
                                    >
                                      ...
                                      {data.validators.map((obj, i) => {
                                        return (
                                          ...
                                          >
                                            {"{"}
                                            <div className="react-simpler-forms-properties">
                                              "method":{" "}
                                              <div className="react-simpler-forms-string">
                                                {obj.method}
                                              </div>
                                              ,
                                            </div>
